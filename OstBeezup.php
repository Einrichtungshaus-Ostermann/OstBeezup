...
class OstBeezup extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_beezup.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_beezup.view_dir', $this->getPath() . '/Resources/views/');
